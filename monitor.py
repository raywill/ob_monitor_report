...
def print_schema(cursor, sql_explain_result, enableDumpDb):
  ...
  report("<div><h2 id='schema_anchor'>SCHEMA 信息</h2><div id='schema' style='display: none'>" + schemas + "</div></div>")
...
<body>
<div class='help'><h1>SQL Monitor Report</h1><p>使用帮助: @晓楚</p></div>
<script>
$(function() {
...
<div id='debug' class="fixed">帮助文档 @晓楚</div>
</body>
</html>
'''
  report(footer)
...
## 两种视图
### 按照 op 聚集
report("<div><h2 id='detail_table_anchor'>SQL_PLAN_MONITOR 详情</h2><div class='v' id='detail_table' style='display: none'>" + ("no result in --fast mode" if enableFastDump else sql_plan_monitor_detail_result.get_html_string()) + "</div><div class='shortcut'><a href='#detail_serial_v1'>Goto 算子优先</a> <a href='#detail_serial_v2'>Goto 线程优先</a></div></div>")
cursor.execute(sql_plan_monitor_detail_v1)
